*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZXXV_ENHPT_REPO
*   generation date: 01/04/2018 at 10:10:56
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZXXV_ENHPT_REPO     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZXXV_ENHPT_REPO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZXXV_ENHPT_REPO_EXTRACT
TOTAL = ZXXV_ENHPT_REPO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZXXV_ENHPT_REPO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZXXV_ENHPT_REPO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZXXV_ENHPT_REPO_EXTRACT
TOTAL = ZXXV_ENHPT_REPO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZXXV_ENHPT_REPO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZXXV_ENHPT_REPO'
...
TOTAL = ZXXV_ENHPT_REPO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZXXV_ENHPT_REPO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZXXV_ENHPT_REPO-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZXXV_ENHPT_REPO'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZXXV_ENHPT_REPO-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZXXV_ENHPT_REPO_EXTRACT
TOTAL = ZXXV_ENHPT_REPO_TOTAL
